...
export const RecoveryPassword = () => {
    ...
    const recoveryEmail = async (e:React.FormEvent) =>{
        e.preventDefault();
        const { currentTarget } = e as React.FormEvent<HTMLFormElement>;
        ...
        if(data == 'Usuario no encontrado') {
            ...
            openDialog();
        } else if (data == 'Solicitud de restablecimiento enviada con éxito') {
            setTypeAlert('success');
            setMessage('Revisa tu correo, no olvides ver la casilla de spam');
            openDialog()
        }
